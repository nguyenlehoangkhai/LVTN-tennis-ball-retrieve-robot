...
<html>
    ...
    section #buttons{display:flex;flex-wrap:nowrap;justify-content:space-between}
          ...
          .input-group input,.input-group select{flex-grow:1}.range-max,.range-min{display:inline-block;padding:0 5px}
      button{display:block;margin:5px;padding:5px 12px;border:0;line-height:28px;cursor:pointer;color:#fff;background:#035806;border-radius:5px;font-size:16px;outline:0;width:100px}
           .button2{background-color:#008cba;width:100px}.button3{background-color:#f44336;width:100px}
           .button4{background-color:#e7e7e7;color:#000;width:120px}.button5{background-color:#555;width:100px}
    ...
    .slider-container{position:relative;top:750px;right:36%;margin-left:-50%;transform:translate(-50%,-50%)}
              ...
              <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.testing.js"></script> -->
                <div id="controls" class="control-container">
                  ...
                  <tr><a href="#"><img id="logo" src="https://upload.wikimedia.org/wikipedia/vi/c/cd/Logo-hcmut.svg"></a>
                      <a href="#"><img id="logo2" src="https://upload.wikimedia.org/wikipedia/vi/c/cd/Logo-hcmut.svg"></a>
                  ...
                  <tr><td align="center"><button class="button button2" id="turnleft" onclick="fetch(document.location.origin+'/control?var=car&val=2');">LEFT</button></td>
                      <td align="center"><button class="button button4"id="retriever">RETRIEVER</button></td>
                      <td align="center"></td><td align="center"><button class="button button2" id="turnright" onclick="fetch(document.location.origin+'/control?var=car&val=4');">RIGHT</button></td></tr>
